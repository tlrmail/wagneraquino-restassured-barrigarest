package br.ce.wcaquino.rest.tests.entities;
...
public class Movimentacao {
	...
	public String toString() {
		return "Movimentacao [id=" + id + ", descricao=" + descricao + ", envolvido=" + envolvido + ", tipo=" + tipo
				+ ", data_transacao=" + data_transacao + ", data_pagamento=" + data_pagamento + ", valor=" + valor
				+ ", status=" + status + ", conta_id=" + conta_id + ", usuario_id=" + usuario_id + "]";
	}
